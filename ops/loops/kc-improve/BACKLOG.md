...
| Consignment chips ellipsize instead of running off the screen — a real shiur title overflowed 320px by 51px, found by re-seeding every display string at the length the book actually reaches | (this commit) | Kol Torah |
