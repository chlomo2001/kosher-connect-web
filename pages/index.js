...
const NAV = [
  ['dashboard', 'Dashboard'], ['customers', 'Customers'], ['rentals', 'Phone Rentals'],
  ['sim', 'SIM Plans'], ['bookings', 'Tickets & Flights'], ['wallet', 'Wallet'],
  ['repairs', 'Repairs'], ['services', 'Online & Print'], ['shop', 'Shop'],
  ['virtual', 'Virtual Numbers'], ['tasks', 'Tasks'], ['settings', 'Settings'],
]
  ...
  return (
    <>
      ...
      <div className="sidebar">
        ...
        {NAV.map(([tab, label], i) => (
          <div key={tab} className={'nav-item' + (i === 0 ? ' active' : '')} data-tab={tab}>
