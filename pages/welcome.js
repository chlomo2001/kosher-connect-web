...
const T = {
  ...
  he: {
    ...
    skip: 'דילוג לתוכן',
    brandName: 'כשר קונקט',
    nav: { mobile: 'סלולר וסים', travel: 'טלפונים לחו״ל', intl: 'מספרים בינלאומיים', repairs: 'תיקונים ועוד', repair: 'הזמנת תיקון', faq: 'שאלות נפוצות', visit: 'בקרו אותנו', message: 'צרו קשר', account: 'האזור האישי' },
    heroEyebrow: 'כשר קונקט · סלפורד, מנצ׳סטר',
    heroTitle: 'חשבון הסלולר שלכם, בחצי המחיר.',
    heroBody: 'כשר קונקט היא חנות סלולר וסים בסלפורד, מנצ׳סטר. רוב האנשים מנויים לחבילה הלא נכונה בלי לשים לב — הביאו לנו את החשבונית האחרונה שלכם ונתאים לכם חבילה לפי אופן השימוש האמיתי שלכם. אותה קליטה, אותו מספר, והרבה פחות כסף.',
    heroPill: 'נשארים עם המספר · משלמים פחות כל חודש',
    ctaMessage: 'צרו קשר', ctaCall: 'התקשרו',
    heroSub: 'כשר קונקט היא חנות סלולר וסים בסלפורד, מנצ׳סטר — טלפונים לחו״ל, מספרים בינלאומיים, תיקונים ועוד, הכול במקום אחד.',
    bands: [
      {
        eyebrow: 'חבילות סלולר וסים',
        title: 'סים כשר, מותאם אישית לשימוש שלכם',
        accent: 'משלמים פחות', sub: 'החבילה הנכונה, בהתאם לצרכים שלכם',
        body: 'הביאו את החשבונית האחרונה שלכם ונעבור עליה יחד, שורה אחר שורה — מה אתם מנצלים, מה מיותר, ואיזו חבילה באמת מתאימה לכם, כולל דקות לחו״ל. אנחנו נדאג לכל תהליך הניוד מאלף ועד תו. בלי התחייבויות ארוכות, בלי מתווכים ובלי אותיות קטנות.',
        chips: ['שומרים על המספר הקיים', 'נשארים עם המכשיר שלכם', 'הניוד עלינו'],
      ...
      {
        eyebrow: 'טלפון לחו״ל',
        title: 'טסים לחו״ל? הטלפון הכשר שלכם כבר מוכן',
        accent: 'ללא חיוב בשבתות וימים טובים', sub: 'תמחור יומי, לא לפי נסיעה',
        ...
        chips: ['מוגדר ומוכן לפני הטיסה', 'תמחור לפי יום', 'שבת ויו״ט בחינם'],
    ...
    moreGroups: [
      {
        label: 'לטלפון שלכם',
        items: [
          { icon: 'wrench', title: 'מעבדת תיקונים', body: 'מסך, סוללה, בעיות טעינה — את רוב התיקונים מסיימים מהר. ואם לא שווה לתקן? נגיד לכם ביושר.', href: '/repair', linkLabel: 'להזמנת תיקון ←' },
    ...
    fName: 'שם מלא', fContact: 'טלפון או דוא״ל', fMsg: 'איך נוכל לעזור?', fSend: 'שלח הודעה', fSending: 'שולחים…',
    ...
    legalPrivacy: 'פרטיות', legalTerms: 'תקנון ותנאי שימוש', legalRefunds: 'מדיניות החזרים',
    ...
    appTitle: 'החשבון המקוון שלכם — מה האפליקציה מאפשרת',
    ...
    appPolicy: 'למדיניות הפרטיות', appAccount: 'מעבר לאזור האישי',
