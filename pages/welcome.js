...
const T = {
  ...
  he: {
    ...
    skip: 'דילוג לתוכן',
    brandName: 'כשר קונקט',
    nav: { mobile: 'חבילות וסים', travel: 'טלפון לחו״ל', intl: 'מספרים בינלאומיים', repairs: 'תיקונים ועוד', repair: 'לקבוע תיקון', faq: 'שאלות נפוצות', visit: 'בקרו אותנו', message: 'דברו איתנו', account: 'האזור האישי' },
    ...
    ctaMessage: 'דברו איתנו', ctaCall: 'התקשרו',
    ...
    bands: [
      ...
      },
      {
        ...
        accent: 'שבת ויום טוב בחינם', sub: 'תמחור יומי, לא לפי נסיעה',
