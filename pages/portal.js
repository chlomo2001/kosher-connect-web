...
const P = {
  en: {
    ...
    payFailed: 'Payment failed. Try again, or pay us in the shop.',
  ...
  he: {
    ...
    paidNote: '✓ התשלום התקבל — תודה רבה. היתרה תתעדכן בהקדם.',
    ...
    payFailed: 'התשלום נכשל. נסו שוב, או שלמו אצלנו בחנות.',
    ...
    saveCardStart: 'שמירת כרטיס אשראי לתשלומים עתידיים',
    ...
    ddOnFile: '✓ הוראת הקבע פעילה — חיובים חודשיים ייגבו מחשבון הבנק שלכם אוטומטית.',
    ddStart: 'הקמת הוראת קבע (חשבון בנק)',
    ...
    simLogin: 'דוא״ל להתחברות', simLoginOurs: 'כתובת שלנו, שהוגדרה עבור קו זה — משמשת להתחברות מול הספק; אין לשלוח אליה הודעות',
    simLoginNone: 'לא רשום דוא״ל להתחברות — התקשרו אלינו ונסדר זאת.',
    simOtp: 'קוד אימות (OTP)', simOtpAt: (t) => `התקבל ${t}`,
    downloadFailed: 'לא הצלחנו לפתוח את הקובץ — נסו שוב, או התקשרו ונדאג לשלוח לכם.',
    renews: (d) => `מתחדשת ב־${d}`,
    renewIn: (n) => (n === 1 ? 'מחר' : `בעוד ${n} ימים`),
    renewToday: 'היום',
    renewOverdueLead: 'החידוש הגיע —', renewOverdueCall: 'התקשרו אלינו',
    bookingRef: 'מספר אסמכתא',
    ...
    reqHint: 'ספרו לנו מה אתם צריכים ונחזור אליכם — בקשה לשיחה חוזרת, שאלה על החבילה, או כל דבר אחר.',
    reqPlaceholder: 'למשל: אנא התקשרו אליי בנוגע לחבילת הסים — עדיף בבוקר, 07...',
    reqSend: 'שליחת פנייה', reqSending: 'שולחים…',
    reqSent: '✓ קיבלנו — נהיה בקשר.',
    ...
    statuses: { active: 'פעיל', out: 'פעילה', booked: 'הוזמן', overdue: 'באיחור תשלום', returned: 'הוחזרה', renewal_pending: 'ממתין לחידוש', cancelled: 'בוטלה', suspended: 'מושהית', Booked: 'הוזמנה', Ticketed: 'כורטסה', Confirmed: 'מאושרת', Cancelled: 'בוטלה', Completed: 'הושלמה' },
    ...
    entryTypes: {
      payment: 'קבלת תשלום', charge: 'חיוב', refund: 'זיכוי',
