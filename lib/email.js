...
const BRAND = {
  ...
  faint: '#94a3b8',
  hair: '#e8ecf1',
  logoUrl: 'https://app.kosher-connect.com/logo-full.png',
  ...
  email: 'admin@kosher-connect.com',
}

export function brandShell({ title, preheader, bodyRows, footNote }) {
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td align="center">
    <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%">
      ...
      <tr><td>
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:14px;overflow:hidden;border:1px solid ${BRAND.hair}">
          ...
          <tr><td style="padding:14px 32px 24px;font-size:12px;color:${BRAND.faint};line-height:1.6;border-top:1px solid ${BRAND.hair}">
            ${footNote ? `${footNote}<br>` : ''}Thank you for choosing Kosher Connect. If anything on this receipt looks wrong, simply reply to this email or call us and we’ll put it right.
          </td></tr>
        </table>
      </td></tr>
      <tr><td style="padding:18px 10px 0;text-align:center;font-size:12px;color:${BRAND.faint};line-height:1.7">
        ...
        <a href="mailto:${BRAND.email}" style="color:${BRAND.muted};text-decoration:none">${esc(BRAND.email)}</a>
      </td></tr>
    </table>
