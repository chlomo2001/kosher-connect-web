...
export const GROUPS = [
  ...
  ['RETURNDUE', 'Due back today', 'The hire has ended — the phone is due in, and nothing is charged yet.'],
  ['OVERDUE', 'Overdue, and now charged', 'Past the return window: the late fee has started.'],
  ...
  ['NOPOOL', 'US Mobile lines with no pool', 'A US Mobile line only activates inside a pool — these are in none, so they will not come up at all.'],
