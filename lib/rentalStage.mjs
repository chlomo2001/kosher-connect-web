...
/**
 * Days past the return date before a phone is called late rather than simply
 * not back yet. The owner-editable value is `rental_return_grace_days`; this is
 * the fallback and MUST match 20260827160000_rental_return_grace.sql.
 */
export const RETURN_GRACE_DAYS = 3
