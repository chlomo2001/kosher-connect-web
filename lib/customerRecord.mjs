// The `icon` on each KIND is an icon NAME — 'phone', 'plane' — and public/main.js
// builds the element from it. It used to be the display markup itself, which is
// how the business summary shipped title="<i class="kc-ic kc-ic-phone"…> to a
// screen reader: one string doing duty as a label, a grouping key and a
// tooltip. A name can only be read as a name. Nothing server-side reads it, and
// test/customerRecordMirror.test.mjs holds this file and its browser mirror
// identical.
