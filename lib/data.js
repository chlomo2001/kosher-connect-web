...
const SUPABASE_URL = (process.env.SUPABASE_URL || 'https://rcpqgujtutvpfzfsgzql.supabase.co').trim()
const SUPABASE_ANON_KEY = (process.env.SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJjcHFndWp0dXR2cGZ6ZnNnenFsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg1MjE5MjAsImV4cCI6MjA5NDA5NzkyMH0.ehkEWg8bd11eH07Li4fXwyeDoj_c5yq5i0gk8eKHSOA').trim()
