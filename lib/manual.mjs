...
export const SCREENS = [
  ...
  },
  {
    ...
    rules: [
      ...
      'On a wide screen the hire list and the phone inventory sit side by side, so you can see what is free without leaving the list you are working in. The inventory shows the number, the country and whether it is free; pool, expiry and the row buttons drop out at that width because there is not room for both tables otherwise \u2014 clicking the row still opens it, and a narrower screen goes back to the full table underneath.',
 ...
 */
export const MANUAL_STAMP = { date: '2026-08-27', fingerprint: 'm-93d80389' }
