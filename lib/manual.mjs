...
export const SCREENS = [
  // ── The frame around every screen ──────────────────────────────────────
  {
    ...
    parts: [
      ...
      ['❓ How do I…', 'The step-by-step answers for the job in front of you, asked in your own words. This is the button for "I have never done this before", and 📖 The full manual sits inside it.'],
