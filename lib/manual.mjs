...
export const SCREENS = [
  ...
  },
  {
    ...
    parts: [
      ...
      ['Communications', 'Email and SMS, each with its safety gate, the addresses post arrives at, a test send, and the log of every message — sent and, once the shop\'s number is wired, the replies customers text back, marked ↩ so the two directions read apart. A text that came in carries a Reply button.'],
