...
export const SCREENS = [
  ...
  },
  {
    ...
    parts: [
      ...
      ['New Service', 'The other half of one-place service: every new thing starts from the card with the person already filled in — a rental, a SIM plan, a flight, a virtual number, a repair, a print job, and the till itself. “Sell at the till” lands on the Shop tab with them attached, wallet credit and usual payment ready, so a visit that wants a rental, a ticket and a few accessories never leaves their card to begin each piece.'],
 ...
 */
export const MANUAL_STAMP = { date: '2026-08-23', fingerprint: 'm-097495d1' }
