...
export const SCREENS = [
  // ── The frame around every screen ──────────────────────────────────────
  {
    ...
    anchors: ['appSidebar', 'navBurger', 'navGrip', 'pageTitle', 'searchBox',
      'btnNewCustomer', 'btnPalette', 'btnAssistant', 'btnHowTo',
    ...
    parts: [
      ...
      ['🤖 Ask', 'Questions about the shop\'s own numbers, in plain words — who owes money, what is overdue. It proposes; nothing happens until you tap to confirm it.'],
      ['❓ How do I…', 'The step-by-step answers, asked in your own words. It opens on the jobs that belong to the screen you are standing on, under "On this screen", with the rest of the library below. This is the button for "I have never done this before", and 📖 The full manual sits inside it.'],
    ...
    dialogs: [],
    rules: [
      'The three help buttons are different tools and it is worth knowing which is which: 🔍 finds things, 🤖 answers questions about the shop\'s numbers, and ❓ tells you how to do a job. Asking the robot how to take a payment gets a confident answer from something that has never stood at the counter.',
