...
// off-session collections — DD phase 1 (docs/DD-PLAN-2026-08-12.md). Explicit
// payment_method_types, not automatic_payment_methods: this flow must offer
// ONLY the bank form, and the two options are mutually exclusive in the API.
export async function createDdSetupIntent({ customerId, appCustomerId }) {
  return stripeApi('setup_intents', {
    body: {
      customer: customerId,
      usage: 'off_session',
      'payment_method_types[]': 'bacs_debit',
      metadata: { app_customer_id: appCustomerId || '', dd_mandate: '1' },
    },
  })
}
